...
static VPOST_T* DisplayDevList[4] = {&DEF_YIDU, &DEF_ILI9341_MPU80, &DEF_LSA40AT9001, &DEF_E50A2V1_RGB565};
...
void vpostLCMInit(uint32_t u32DisplayPanelID)
{
	  ...
	  //REG_OPERATE(REG_LCM_DCCS,0x01,set);
   ...
   // REG_OPERATE(REG_LCM_DEV_CTRL,0x10000000,set);
	  //REG_OPERATE(REG_LCM_DEV_CTRL,0x00000004,set);
	
	//REG_OPERATE(REG_LCM_DEV_CTRL,1<<17,set);
	//REG_OPERATE(REG_LCM_DEV_CTRL,1<<18,set);
    ...
    sysprintf("curDisplayDev.u32Cmd16t18=%x\r\n",curDisplayDev.u32Cmd16t18);
		...
		sysprintf("curDisplayDev.u32DataBusWidth=%x\r\n",curDisplayDev.u32DataBusWidth); 
		sysprintf("curDisplayDev.u32MPU_Mode=%x\r\n",curDisplayDev.u32MPU_Mode); 
		sysprintf("curDisplayDev.u32DisplayColors=%x\r\n",curDisplayDev.u32DisplayColors); 
		sysprintf("curDisplayDev.u32DevType=%x\r\n",curDisplayDev.u32DevType); 
		sysprintf("curDisplayDev.u32Reg_CRTCSIZE=%x\r\n",curDisplayDev.u32Reg_CRTCSIZE); 
		sysprintf("curDisplayDev.u32Reg_CRTCDEND=%x\r\n",curDisplayDev.u32Reg_CRTCDEND); 
		sysprintf("curDisplayDev.u32Reg_CRTCHR=%x\r\n",curDisplayDev.u32Reg_CRTCHR);
		sysprintf("curDisplayDev.u32Reg_CRTCHSYNC=%x\r\n",curDisplayDev.u32Reg_CRTCHSYNC);
...
//		u8BufPtr = (void *)(800*480*u32BytePerPixel + 32);
//		u8BufPtr = (uint8_t *)shift_pointer((uint32_t)u8BufPtr, 32);
//		//u8BufPtr = (void *)(0x3d7a40);
//	 outpw(REG_LCM_VA_BADDR0, ((uint32_t)u8BufPtr| 0x80000000)) ;
