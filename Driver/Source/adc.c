...
INT adcOpen2(uint32_t freqKhz)
{
  ...
  //outpw(REG_CLK_DIVCTL7, inpw(REG_CLK_DIVCTL7) & ~((0x3<<19)|(0x7<<16)|(0xFFul<<24)));
   // outpw(REG_CLK_DIVCTL7, (0<<19)|(0<<16)|((div-1)<<24));
	//outpw(REG_CLK_DIVCTL7, (3<<19)|(2<<16)|(99<<24));//1M
	REG_OPERATE(REG_CLK_DIVCTL7,0xffffffff,clear);
	//REG_OPERATE(REG_CLK_DIVCTL7,(3<<19)|(10<<16)|(99<<24),set);//200K
	//////////////////////////REG_OPERATE(REG_CLK_DIVCTL7,(3<<19)|(10<<16)|(99<<24),set);
	REG_OPERATE(REG_CLK_DIVCTL7,(3<<19)|(2<<16)|(99<<24),set);//1M
//	REG_OPERATE(REG_CLK_DIVCTL7,(24<<24),set);//1M
