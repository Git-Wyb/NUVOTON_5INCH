...
//	NAND_EraseBlock(baseA_data__nandflash_start/64);
   ...
   BASEDATA_RAM_INIT();
	...
	if((bmp_TAB[0]!=800)||(bmp_TAB[1]!=480))//不支持的格式
	{
		return;
	}		
...
//	  sysprintf("点亮LED0和LED1....\r\n");
//	  delay_ms(2000);
//	  //关闭LED0和LED1
//	  GPIO_Set(GPIOB,BIT4|BIT5);
//		sysprintf("关闭LED0和LED1....\r\n");
//	  delay_ms(2000);
//		
//		//LED0和LED1交替闪烁
//		sysprintf("LED0和LED1交替闪烁....CYW\r\n");
}
...
////////////////////////	}
    REG_OPERATE(REG_CLK_PCLKEN0,1<<1,set);//ENABLE WWDT
    WWDT_Open(WWDT_PRESCALER_2048,0xf,TRUE);//约1.35S后复位
}