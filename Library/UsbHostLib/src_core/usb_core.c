...
//	#endif
  ...
  // #ifdef ENABLE_OHCI
	...
	//#endif
	  ...
	  sysprintf("_drivers=%X,sizeof(_drivers)=%X\r\n",_drivers,sizeof(_drivers));
...
int  connect_device(UDEV_T *udev)
{
    ...
    delay_us(10000 /** 1000*/);                   /* initially, give 100 ms delay               */
    ...
    delay_us(10000 /** 1000*/);                   /* after set address, give 100 ms delay       */
